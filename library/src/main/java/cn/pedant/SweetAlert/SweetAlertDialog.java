...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
	...
	private boolean mShowThirdButton;
	...
	private OnSweetClickListener mThirdClickListener;
	private OnSweetClickListener mConfirmClickListener;
	private OnSweetClickListener mCheckBoxClickListener;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mCheckBox = (CheckBox) findViewById(R.id.sweetSec);
		...
		showThirdButton(mShowThirdButton);
		showCheckox(mShowCheckbox);
		setCancelText(mCancelText);
		setThirdButtonText(mThirdText);
		setCheckBoxText(mCheckBoxText);
	...
	public SweetAlertDialog setContentTextSize(int size) {
	...
	public SweetAlertDialog showThirdButton(boolean isShow) {
		mShowThirdButton = isShow;
		if (mThirdButton != null) {
			mThirdButton.setVisibility(mShowThirdButton ? View.VISIBLE
					: View.GONE);
		}
		return this;
	}
	
	public SweetAlertDialog showCheckox(boolean isShow) {
		mShowCheckbox = isShow;
		if (mCheckBox != null) {
			mCheckBox.setVisibility(mShowCheckbox ? View.VISIBLE: View.GONE);
		}
		return this;
	}	
	...
	public SweetAlertDialog setThirdButtonText(String text) {
		mThirdText = text;
		if (mThirdButton != null && mThirdText != null) {
			mThirdButton.setText(mThirdText);
		}
		return this;
	}
	
	public SweetAlertDialog setCheckBoxText(String text) {
		mCheckBoxText = text;
		if (mCheckBox != null && mCheckBoxText != null) {
	...
	public SweetAlertDialog setThirdButtonClickListener(
	...
	public SweetAlertDialog setCheckBoxClickListener(OnSweetClickListener listener) {
	...
	public void onClick(View v) {
		...
		case R.id.third_button:
			if (mThirdClickListener != null) {
				mThirdClickListener.onClick(SweetAlertDialog.this);
			} else {
				dismiss();
			}
			break;		
		case R.id.sweetSec:
			if (mCheckBoxClickListener != null) {
				mCheckBoxClickListener.onClick(SweetAlertDialog.this);
			} else {
				dismiss();
			}
			break;				
